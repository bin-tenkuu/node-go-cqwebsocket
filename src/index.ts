import {CQEvent, EventType, MessageEventType, SocketEventType} from "./event-bus";
import * as Tags from "./tags";
import {CQNode, CQTag} from "./tags";
import {APIRequest, SocketType, WebSocketCQ} from "./websocket";
...
export interface CQWebSocket {
  ...
  on(eventType: MessageEventType, handler: (event: CQEvent, message: any, CQTag: CQTag[]) => void): this
  ...
  once(eventType: MessageEventType, handler: (event: CQEvent, message: any, CQTag: CQTag[]) => void): this

  once(eventType: EventType, handler: (event: CQEvent, message: any) => void): this

  off(eventType: "socket.open", handler: (event: CQEvent, type: SocketType) => void): this

  off(eventType: "socket.close" | "socket.error", handler: (event: CQEvent, code: number, reason: string, type: SocketType) => void): this

  off(eventType: "api.preSend", handler: (event: CQEvent, message: APIRequest) => void): this

  off(eventType: MessageEventType, handler: (event: CQEvent, message: any, CQTag: CQTag[]) => void): this

  off(eventType: Exclude<ExcludeEventType, EventType>, handler: (event: CQEvent, message: any) => void): this
}

type ExcludeEventType = MessageEventType | SocketEventType
